...
<div id="contenedor"><span id="titulo"><fmt:message key="report.revenue"/></span> <br>
...
<tbody>
	...
	<tfoot>
        <tr>
        	<td colspan="3" class="rounded-foot-left"><em><fmt:message key="report.revenue"/></em></td>
...
<a href="generadorPDF.htm?tipo=1"  style="text-decoration:none;" target="_blank" ><img border="0" name="pdf" title="pdf" alt="generarPDF" src="<c:url value="/images/pdf.gif"/>" /></a>
&nbsp&nbsp&nbsp<a href="generadorExcel.htm?tipo=1"  style="text-decoration:none;" target="_blank" ><img border="0" name="pdf" title="pdf" alt="generarPDF" src="<c:url value="/images/excel_icon.gif"/>" /></a>
</fieldset>
<br>
</div>
</body>
