...
<div id="contenedor"><span id="titulo"><fmt:message key="report.confiteria"/></span> <br>
...
<thead>
	<tr>
		...
		<th><c:out value="${fecha_inicio_primer_periodo}"/> al <br><c:out value="${fecha_fin_primer_periodo}"/></th>
		<th><c:out value="${fecha_inicio_segundo_periodo}"/> al <br><c:out value="${fecha_fin_segundo_periodo}"/></th>
...
<tbody>
	...
	<tfoot>
        <tr>
        	<td colspan="3" class="rounded-foot-left"><em><fmt:message key="report.confiteria"/></em></td>
...
<a href="generadorPDF.htm?tipo=3"  style="text-decoration:none;" target="_blank" ><img border="0" name="pdf" title="pdf" alt="generarPDF" src="<c:url value="/images/pdf.gif"/>" /></a>
&nbsp;&nbsp;&nbsp;<a href="generadorExcel.htm?tipo=3"  style="text-decoration:none;" target="_blank" ><img border="0" name="pdf" title="pdf" alt="generarPDF" src="<c:url value="/images/excel_icon.gif"/>" /></a>
</fieldset>
<br>
</div>
</body>
