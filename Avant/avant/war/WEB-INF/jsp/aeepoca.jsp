...
<div id="contenedor"><span id="titulo"><fmt:message key="epochs" /></span> <br>


<div id="form-area">
	<form:form method="post" commandName="agregar">
	<fieldset  style="width: 200px;">
<legend><fmt:message key="add" /> <fmt:message key="epoch" /></legend>
<table id="tablaForm">
<tr>
		...
		<thead>
			...
			<c:forEach items="${epocas}" var="e">
				<tr>
					...
					<td><a href="<c:url value="admin_eliminarepoca.htm?idepoca=${e.id}"/>"><fmt:message key="eliminate"></fmt:message></a></td>
				</tr>
			</c:forEach>
			</tbody>
			 <tfoot>
        <tr>
        	<td colspan="2" class="rounded-foot-left"><em><a href="admin_epocas.htm"><fmt:message key="modify" /> <fmt:message key="epochs" /></a></em></td>
